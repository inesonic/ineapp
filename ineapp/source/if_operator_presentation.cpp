...
* \file
*
* This file implements the \ref IfOperatorPresentation class.
***********************************************************************************************************************/
...
IfOperatorPresentation::IfOperatorPresentation() {}


IfOperatorPresentation::~IfOperatorPresentation() {}


Ld::Visual* IfOperatorPresentation::creator(const QString&) {
    return new IfOperatorPresentation();
}


EQt::GraphicsMathGroup* IfOperatorPresentation::buildGraphicsItem(
    ...
    return IfOperatorPresentation::updateGraphicsItem(
        format,
...
EQt::GraphicsMathGroup* IfOperatorPresentation::updateGraphicsItem(
        Ld::FormatPointer                          format,
