...
* \file
*
* This header defines the \ref BlockFormatBuilderMid class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef BLOCK_FORMAT_BUILDER_MID_H
#define BLOCK_FORMAT_BUILDER_MID_H
 ...
 *
 *     * The list format dialog menu function.
 *
 * This class performs most of the work required to setup the GUI to support block formats.  Note that a few key
 * actions are created by \ref BlockFormatBuilderEarly.
 */
class BlockFormatBuilderMid:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        static constexpr unsigned builderPriority = 600;
         ...
         */
        explicit BlockFormatBuilderMid(QObject* parent = Q_NULLPTR);

        ~BlockFormatBuilderMid() override;
