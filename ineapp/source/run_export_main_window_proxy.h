...
* \file
*
* This header defines the \ref RunExportMainWindowProxy class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef RUN_EXPORT_MAIN_WINDOW_PROXY_H
#define RUN_EXPORT_MAIN_WINDOW_PROXY_H
 ...
 */
class RunExportMainWindowProxy:public EQt::ProgrammaticMainWindowProxy {
    Q_OBJECT
    ...
    public:
         ...
         */
        RunExportMainWindowProxy(EQt::ProgrammaticMainWindow* window);

        ~RunExportMainWindowProxy() override;
    ...
    private slots:
        /**
         * Slot that is triggered when the build progress bar timer times out.
         */
        void buildProgressBarTimeout();

        /**
         * Slot that is triggered when the execute progress bar timer times out.
         */
        void executeProgressBarTimeout();
