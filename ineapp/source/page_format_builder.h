...
* \file
*
* This header defines the \ref PageFormatBuilder class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef PAGE_FORMAT_BUILDER_H
#define PAGE_FORMAT_BUILDER_H
...
/**
 * Builer for the application's page format user interface functions.  These functions include:
 *
 *     * Support for the the Page format dialog.
 *     * Page formatting dock widget items.
 */
class PageFormatBuilder:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        static constexpr unsigned builderPriority = 300;
         ...
         */
        static const char pageFormatDockName[];
         ...
         */
        explicit PageFormatBuilder(QObject* parent = Q_NULLPTR);

        ~PageFormatBuilder() override;
    ...
    private:
        /**
         * Builds the page format dock widget's horizontal orientation.
         *
        ...
        /**
         * Builds the page format dock widget's vertical orientation.
         *
         * \param[in] dock           The dock widget being populated.
         *
