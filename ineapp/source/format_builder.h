...
* \file
*
* This header defines the \ref FormatBuilder class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef FORMAT_BUILDER_H
#define FORMAT_BUILDER_H
...
/**
 * Builer for the application's format user interface functions.  These functions include:
 *
 *     * Basic format menu items
 *     * Basic formatting dock widget functions.
 */
class FormatBuilder:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        explicit FormatBuilder(QObject* parent = Q_NULLPTR);

        ~FormatBuilder() override;
         ...
         */
        void registerResources(EQt::ProgrammaticApplication* application) final;
    ...
    private:
        /**
         * Bulds the home dock widget's horizontal orientation.
         *
         ...
         */
        void buildFormatDockHorizontalOrientation(
        ...
        /**
         * Bulds the home dock widget's vertical orientation.
         *
         * \param[in] dock           The dock widget being populated.
         *
         ...
         * \param[in] window         Pointer to the main window object.
         */
        void buildFormatDockVerticalOrientation(
            EQt::ProgrammaticDockWidget* dock,
