...
* \file
*
* This header defines the \ref CharacterFormatBuilderLate class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef CHARACTER_FORMAT_BUILDER_LATE_H
#define CHARACTER_FORMAT_BUILDER_LATE_H
 ...
 *
 * This class performs most of the work required to setup the GUI to support character formats.  Note that a few key
 * actions are created by \ref CharacterFormatBuilderEarly.
 */
class CharacterFormatBuilderLate:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        static constexpr unsigned builderPriority = 3100;
         ...
         */
        static const char characterFormatDockName[];
         ...
         */
        explicit CharacterFormatBuilderLate(QObject* parent = Q_NULLPTR);

        ~CharacterFormatBuilderLate() override;
    ...
    private:
        /**
         * Builds the character format dock widget's horizontal orientation.
         *
        ...
        /**
         * Builds the character format dock widget's vertical orientation.
         *
         * \param[in] dock           The dock widget being populated.
         *
