...
* \file
*
* This header defines the \ref PlotBuilder class.
***********************************************************************************************************************/
...
/**
 * Builer for the application's plot functions.
 */
class PlotBuilder:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        static constexpr unsigned builderPriority = 6000;
         ...
         */
        explicit PlotBuilder(QObject* parent = Q_NULLPTR);

        ~PlotBuilder() override;
