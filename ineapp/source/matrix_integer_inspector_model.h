...
* \file
*
* This header defines the \ref MatrixIntegerInspectorModel class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef MATRIX_INTEGER_INSPECTOR_MODEL_H
#define MATRIX_INTEGER_INSPECTOR_MODEL_H
...
/**
 * Class that provides a model for integer matrices.
 */
class MatrixIntegerInspectorModel:public MatrixInspectorModel {
    Q_OBJECT
    ...
    public:
         ...
         */
        MatrixIntegerInspectorModel(const Ld::CalculatedValue& calculatedValue, QObject* parent = Q_NULLPTR);

        ~MatrixIntegerInspectorModel() override;
    ...
    private:
         ...
         * The input matrix.
         */
        Model::MatrixInteger inputMatrix;
