...
* \file
*
* This header defines the \ref TableFormatMainWindowProxy class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef TABLE_FORMAT_MAIN_WINDOW_PROXY_H
#define TABLE_FORMAT_MAIN_WINDOW_PROXY_H
 ...
 */
class TableFormatMainWindowProxy:public EQt::ProgrammaticMainWindowProxy {
    Q_OBJECT
    ...
    public:
         ...
         */
        TableFormatMainWindowProxy(EQt::ProgrammaticMainWindow* window);

        ~TableFormatMainWindowProxy() override;
    ...
    private:
        /**
         * Method that is called by \ref TableFormatMainWindowProxy::loadSettings to load settings for a single
        ...
        /**
         * Method that is called by \ref TableFormatMainWindowProxy::saveSettings to load settings for a single
         * dimension line edit field.
         *
         * \param[in] widgetName   The name of the widget in the dock.
         */
