...
* \file
*
* This header defines the \ref PageBreakBuilder class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef PAGE_BREAK_BUILDER_H
#define PAGE_BREAK_BUILDER_H
 ...
 */
class PageBreakBuilder:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        static constexpr unsigned builderPriority = 4000;
         ...
         */
        explicit PageBreakBuilder(QObject* parent = Q_NULLPTR);

        ~PageBreakBuilder() override;
