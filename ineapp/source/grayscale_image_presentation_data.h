...
* \file
*
* This header defines the \ref GrayscaleImagePresentationData class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef GRAYSCALE_IMAGE_PRESENTATION_DATA_H
#define GRAYSCALE_IMAGE_PRESENTATION_DATA_H
...
/**
 * The \ref PlotPresentationData instance to use for grayscale images rendered as plots.
 */
class APP_PUBLIC_API GrayscaleImagePresentationData:public ImageRenderPresentationData {
    Q_DECLARE_TR_FUNCTIONS(GrayscaleImagePresentationData)

    public:
        GrayscaleImagePresentationData();

        ~GrayscaleImagePresentationData() override;
