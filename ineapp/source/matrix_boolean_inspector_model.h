...
* \file
*
* This header defines the \ref MatrixBooleanInspectorModel class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef MATRIX_BOOLEAN_INSPECTOR_MODEL_H
#define MATRIX_BOOLEAN_INSPECTOR_MODEL_H
...
/**
 * Class that provides a model for boolean matrices.
 */
class MatrixBooleanInspectorModel:public MatrixInspectorModel {
    Q_OBJECT
    ...
    public:
         ...
         */
        MatrixBooleanInspectorModel(const Ld::CalculatedValue& calculatedValue, QObject* parent = Q_NULLPTR);

        ~MatrixBooleanInspectorModel() override;
    ...
    private:
         ...
         * The input matrix.
         */
        Model::MatrixBoolean inputMatrix;
