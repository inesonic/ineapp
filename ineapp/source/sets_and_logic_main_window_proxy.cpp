...
* \file
*
* This file implements the \ref SetsAndLogicMainWindowProxy class.
***********************************************************************************************************************/
...
SetsAndLogicMainWindowProxy::SetsAndLogicMainWindowProxy(
...
void SetsAndLogicMainWindowProxy::bind() {
    connect(Application::instance(), &Application::screenResized, this, &SetsAndLogicMainWindowProxy::screenResized);
}


void SetsAndLogicMainWindowProxy::windowConfigured() {
    EQt::ProgrammaticDockWidget* dock = window()->dockWidget(SetsAndLogicBuilder::setsAndLogicDockName);
...
void SetsAndLogicMainWindowProxy::screenResized() {
    windowConfigured();
}
