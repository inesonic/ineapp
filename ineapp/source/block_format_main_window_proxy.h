...
* \file
*
* This header defines the \ref BlockFormatMainWindowProxy class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef BLOCK_FORMAT_MAIN_WINDOW_PROXY_H
#define BLOCK_FORMAT_MAIN_WINDOW_PROXY_H
 ...
 */
class BlockFormatMainWindowProxy:public EQt::ProgrammaticMainWindowProxy {
    Q_OBJECT
    ...
    public:
         ...
         */
        BlockFormatMainWindowProxy(EQt::ProgrammaticMainWindow* window);

        ~BlockFormatMainWindowProxy() override;
    ...
    private:
        /**
         * Method that is called by \ref BlockFormatMainWindowProxy::loadSettings to load settings for a single
        ...
        /**
         * Method that is called by \ref BlockFormatMainWindowProxy::saveSettings to load settings for a single
         * dimension line edit field.
         *
         * \param[in] widgetName   The name of the widget in the dock.
         */
