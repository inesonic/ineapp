...
* \file
*
* This header defines the \ref MatrixBuilder class.
***********************************************************************************************************************/
...
/**
 * Builer for the application's matrix functions.
 */
class MatrixBuilder:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        static constexpr unsigned builderPriority = 10200;
        ...
        /**
         * The matrix dock name
         */
        static const char matrixDockName[];
         ...
         */
        explicit MatrixBuilder(QObject* parent = Q_NULLPTR);

        ~MatrixBuilder() override;
    ...
    private:
         ...
         * \param[in] window     Pointer to the main window object.
         */
        void buildDockCommonComponents(
