...
* \file
*
* This header defines the \ref BasicMathBuilder class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef BASIC_MATH_BUILDER_H
#define BASIC_MATH_BUILDER_H
...
/**
 * Builer for the application's basic math functions.
 */
class BasicMathBuilder:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        static constexpr unsigned builderPriority = 10000;
        ...
        /**
         * The basic math dock name
         */
        static const char basicMathDockName[];
         ...
         */
        explicit BasicMathBuilder(QObject* parent = Q_NULLPTR);

        ~BasicMathBuilder() override;
