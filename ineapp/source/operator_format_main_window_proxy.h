...
* \file
*
* This header defines the \ref OperatorFormatMainWindowProxy class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef OPERATOR_FORMAT_MAIN_WINDOW_PROXY_H
#define OPERATOR_FORMAT_MAIN_WINDOW_PROXY_H
...
/**
 * Main window proxy used to support operator formats.
 */
class OperatorFormatMainWindowProxy:public EQt::ProgrammaticMainWindowProxy {
    Q_OBJECT
    ...
    public:
         ...
         */
        OperatorFormatMainWindowProxy(EQt::ProgrammaticMainWindow* window);

        ~OperatorFormatMainWindowProxy() override;
