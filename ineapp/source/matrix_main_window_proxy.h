...
* \file
*
* This header defines the \ref MatrixMainWindowProxy class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef MATRIX_MAIN_WINDOW_PROXY_H
#define MATRIX_MAIN_WINDOW_PROXY_H
...
/**
 * Main window proxy used to support matrix functions.
 */
class MatrixMainWindowProxy:public EQt::ProgrammaticMainWindowProxy {
    Q_OBJECT
    ...
    public:
         ...
         */
        MatrixMainWindowProxy(EQt::ProgrammaticMainWindow* window);

        ~MatrixMainWindowProxy() override;
