...
* \file
*
* This header defines the \ref ControlFlowBuilder class.
***********************************************************************************************************************/
...
/**
 * Builder for the application's control flow functions.
 */
class ControlFlowBuilder:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        static const char controlFlowDockName[];
         ...
         */
        explicit ControlFlowBuilder(QObject* parent = Q_NULLPTR);

        ~ControlFlowBuilder() override;
    ...
    private:
        ...
        /**
         * Method that can be used to build the horizontal and vertical dock common portions.
         *
         * \param[in] gridLayout The grid layout to use for the common components.
         *
         * \param[in] window     Pointer to the main window object.
         *
         * \param[in] topOffset  The top offset into the grid layout where the buttons should start.
         *
         * \param[in] leftOffset The left offset into the grid layout where the buttons should start.
         */
        void buildDockTopComponents(
