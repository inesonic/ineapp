...
* \file
*
* This header defines the \ref HomeBuilderInitial class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef HOME_BUILDER_INITIAL_H
#define HOME_BUILDER_INITIAL_H
 ...
 */
class HomeBuilderInitial:public EQt::Builder {
    Q_OBJECT
    ...
    public:
         ...
         */
        static constexpr unsigned builderPriority = 100;
         ...
         * Home dock name.
         */
        static const char homeDockName[];

        /**
         * Home dock name.
         */
        static const char insertDockName[];
         ...
         */
        explicit HomeBuilderInitial(QObject* parent = Q_NULLPTR);

        ~HomeBuilderInitial() override;
    ...
    private:
        /**
         * Builds the home dock widget's horizontal orientation.
         *
         ...
         */
        void buildHomeDockHorizontalOrientation(
        ...
        /**
         * Builds the home dock widget's vertical orientation.
         *
         * \param[in] dock           The dock widget being populated.
         *
         ...
         * \param[in] window         Pointer to the main window object.
         */
        void buildHomeDockVerticalOrientation(
            EQt::ProgrammaticDockWidget* dock,
        ...
        /**
         * Builds the insert dock widget's horizontal orientation.
         *
         * \param[in] dock             The dock widget being populated.
         *
         * \param[in] horizontalLayout The QHBoxLayout to use for the horizontal orientation.
         ...
         * \param[in] window           Pointer to the main window object.
         */
        void buildInsertDockHorizontalOrientation(
            EQt::ProgrammaticDockWidget* dock,
            QHBoxLayout*                 horizontalLayout,
            EQt::ProgrammaticMainWindow* window
        );
        ...
        /**
         * Builds the insert dock widget's vertical orientation.
         *
         * \param[in] dock           The dock widget being populated.
         *
         * \param[in] verticalLayout The QHBoxLayout to use for the vertical orientation.
         ...
         * \param[in] window         Pointer to the main window object.
         */
        void buildInsertDockVerticalOrientation(
            EQt::ProgrammaticDockWidget* dock,
            QVBoxLayout*                 verticalLayout,
            EQt::ProgrammaticMainWindow* window
        );
