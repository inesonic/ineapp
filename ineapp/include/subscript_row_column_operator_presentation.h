...
* \file
*
* This header defines the \ref SubscriptRowColumnOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef SUBSCRIPT_ROW_COLUMN_OPERATOR_PRESENTATION_H
#define SUBSCRIPT_ROW_COLUMN_OPERATOR_PRESENTATION_H
...
/**
 * This class provides a presentation for the Ld::SubscriptRowColumnOperatorElement class.
 */
class APP_PUBLIC_API SubscriptRowColumnOperatorPresentation:public         OperatorPresentationBase,
                                                            public virtual Ld::SubscriptRowColumnOperatorVisual {
    Q_OBJECT

    public:
        SubscriptRowColumnOperatorPresentation();

        ~SubscriptRowColumnOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref SubscriptRowColumnOperatorPresentation class.
         *
