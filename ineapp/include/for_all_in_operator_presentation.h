...
* \file
*
* This header defines the \ref ForAllInOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef FOR_ALL_IN_OPERATOR_PRESENTATION_H
#define FOR_ALL_IN_OPERATOR_PRESENTATION_H
...
/**
 * This class provides a presentation for the Ld::ForAllInOperatorElement class.
 */
class APP_PUBLIC_API ForAllInOperatorPresentation:public         ControlFlowOperatorPresentationBase,
                                                  public virtual Ld::ForAllInOperatorVisual {
    Q_OBJECT

    public:
        ForAllInOperatorPresentation();

        ~ForAllInOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref ForAllInOperatorPresentation class.
         *
