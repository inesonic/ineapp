...
* \file
*
* This header defines the \ref MatrixBooleanDataTypePresentationGenerator class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef MATRIX_BOOLEAN_DATA_TYPE_PRESENTATION_GENERATOR_H
#define MATRIX_BOOLEAN_DATA_TYPE_PRESENTATION_GENERATOR_H
 ...
 */
class APP_PUBLIC_API MatrixBooleanDataTypePresentationGenerator:public virtual MatrixDataTypePresentationGeneratorBase,
                                                                public virtual Ld::MatrixBooleanDataTypeDecoder {
    public:
        /**
         * Contexts used to render boolean matricies.
         */
        class APP_PUBLIC_API Context:public virtual MatrixDataTypePresentationGeneratorBase::Context,
            ...
            public:
                 ...
                 *
                 * \param[in] relativeScale The relative scale to apply to the rendered value.
                 */
                Context(const Model::MatrixBoolean& matrix, Ld::FormatPointer format, float relativeScale);
         ...
         */
        static const MatrixBooleanDataTypePresentationGenerator instance;

        MatrixBooleanDataTypePresentationGenerator();

        ~MatrixBooleanDataTypePresentationGenerator() override;
