...
* \file
*
* This header defines the \ref MatrixCombineLeftToRightOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef MATRIX_COMBINE_LEFT_TO_RIGHT_OPERATOR_PRESENTATION_H
#define MATRIX_COMBINE_LEFT_TO_RIGHT_OPERATOR_PRESENTATION_H
...
/**
 * This class provides a presentation for the Ld::MatrixCombineLeftToRightOperatorElement class.
 */
class APP_PUBLIC_API MatrixCombineLeftToRightOperatorPresentation:
        public         MatrixOperatorPresentationBase,
        public virtual Ld::MatrixCombineLeftToRightOperatorVisual
    {
    Q_OBJECT

    public:
        MatrixCombineLeftToRightOperatorPresentation();

        ~MatrixCombineLeftToRightOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref MatrixCombineLeftToRightOperatorPresentation class.
         *
