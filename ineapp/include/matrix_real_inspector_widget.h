...
* \file
*
* This header defines the \ref MatrixRealInspectorWidget class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef MATRIX_REAL_INSPECTOR_WIDGET_H
#define MATRIX_REAL_INSPECTOR_WIDGET_H
...
/**
 * Inspector widget for real matrix variables.
 */
class APP_PUBLIC_API MatrixRealInspectorWidget:public MatrixInspectorWidget {
    Q_OBJECT
    ...
    public:
         ...
         */
        MatrixRealInspectorWidget(QWidget* parent = Q_NULLPTR);

        ~MatrixRealInspectorWidget() override;
