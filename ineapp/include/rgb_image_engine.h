...
* \file
*
* This header defines the \ref RgbImageEngine class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef RGB_IMAGE_ENGINE_H
#define RGB_IMAGE_ENGINE_H
...
/**
 * Class that implements a plot-like renderer for RGB images.
 */
class APP_PUBLIC_API RgbImageEngine:public ImageRenderEngine {
    Q_DECLARE_TR_FUNCTIONS(RgbImageEngine)

    public:
        /**
         * Global instance.
         */
        static const RgbImageEngine instance;

        RgbImageEngine();

        ~RgbImageEngine() override;
