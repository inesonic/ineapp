...
* \file
*
* This header defines the \ref UnaryLargeOperatorPresentationBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef UNARY_LARGE_OPERATOR_PRESENTATION_BASE_H
#define UNARY_LARGE_OPERATOR_PRESENTATION_BASE_H
...
/**
 * You can use this class as a base class for large unary operator presentations.
 */
class APP_PUBLIC_API UnaryLargeOperatorPresentationBase:public OperatorPresentationBase {
    Q_OBJECT

    public:
        UnaryLargeOperatorPresentationBase();

        ~UnaryLargeOperatorPresentationBase() override;
