...
* \file
*
* This header defines the \ref PowerOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef POWER_OPERATOR_PRESENTATION_H
#define POWER_OPERATOR_PRESENTATION_H
...
/**
 * This class provides a presentation for the Ld::PowerOperatorElement class.
 */
class APP_PUBLIC_API PowerOperatorPresentation:public         OperatorPresentationBase,
                                               public virtual Ld::PowerOperatorVisual {
    Q_OBJECT

    public:
        PowerOperatorPresentation();

        ~PowerOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref PowerOperatorPresentation class.
         *
