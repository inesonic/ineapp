...
* \file
*
* This header defines the \ref FunctionPlaceholderPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef FUNCTION_PLACEHOLDER_PRESENTATION_H
#define FUNCTION_PLACEHOLDER_PRESENTATION_H
 ...
 */
class APP_PUBLIC_API FunctionPlaceholderPresentation:public         SpecialSymbolPresentationBase,
                                                     public virtual Ld::FunctionPlaceholderVisual {
    Q_OBJECT

    public:
        FunctionPlaceholderPresentation();

        ~FunctionPlaceholderPresentation() override;

        /**
         * Static method that creates an instance of a \ref FunctionPlaceholderPresentation class.
         *
