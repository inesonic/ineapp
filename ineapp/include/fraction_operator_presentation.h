...
* \file
*
* This header defines the \ref FractionOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef FRACTION_OPERATOR_PRESENTATION_H
#define FRACTION_OPERATOR_PRESENTATION_H
 ...
 */
class APP_PUBLIC_API FractionOperatorPresentation:public DivisionOperatorPresentationBase {
    Q_OBJECT

    public:
        FractionOperatorPresentation();

        ~FractionOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref FractionOperatorPresentation class.
         *
