...
* \file
*
* This header defines the \ref LiteralPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef LITERAL_PRESENTATION_H
#define LITERAL_PRESENTATION_H
...
/**
 * This class provides a visual for the Ld::LiteralElement class with full support for presenting a
 * Ld::LiteralElement within the document view of a program.
 */
class APP_PUBLIC_API LiteralPresentation:public LeafPresentation, public virtual Ld::LiteralVisual {
    Q_OBJECT

    public:
        LiteralPresentation();

        ~LiteralPresentation() override;

        /**
         * Static method that creates an instance of a \ref LiteralPresentation class.
         *
    ...
    private:
        ...
        /**
         * Method that determines the section and offset holding a specific character.
         *
         * \param[in]  sectionList     The list of sections.
         *
         * \param[in]  characterIndex  Zero based character index we wish to locate the section for.
         *
         * \param[out] sectionNumber   The section holding the character.
         *
         * \param[out] characterOffset The offset into the section where the character resides.
         *
         * \return Returns true if the character exists in a section.  Returns false if the character does not exist
         *         in any section.
         */
        static bool locateSection(
