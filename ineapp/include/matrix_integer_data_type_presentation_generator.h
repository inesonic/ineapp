...
* \file
*
* This header defines the \ref MatrixIntegerDataTypePresentationGenerator class.
*********************************************************f**************************************************************/

/* .. sphinx-project ineapp */

#ifndef MATRIX_INTEGER_DATA_TYPE_PRESENTATION_GENERATOR_H
#define MATRIX_INTEGER_DATA_TYPE_PRESENTATION_GENERATOR_H
...
class PlaementTracker;

/**
 * Presentation generator that renders integer matrices.
 */
class APP_PUBLIC_API MatrixIntegerDataTypePresentationGenerator:public virtual MatrixDataTypePresentationGeneratorBase,
                                                                public virtual Ld::MatrixIntegerDataTypeDecoder {
    public:
        /**
         * Contexts used to render integer matricies.
         */
        class APP_PUBLIC_API Context:public virtual MatrixDataTypePresentationGeneratorBase::Context,
            ...
            public:
                 ...
                 *
                 * \param[in] relativeScale The relative scale to apply when rendering the presentation.
                 */
                Context(const Model::MatrixInteger& matrix, Ld::FormatPointer format, float relativeScale);
         ...
         */
        static const MatrixIntegerDataTypePresentationGenerator instance;

        MatrixIntegerDataTypePresentationGenerator();

        ~MatrixIntegerDataTypePresentationGenerator() override;
