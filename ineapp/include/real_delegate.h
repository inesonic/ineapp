...
* \file
*
* This header defines the \ref RealDelegate class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef REAL_DELEGATE_H
#define REAL_DELEGATE_H
...
/**
 * Class that provides a delegate for real values.
 */
class APP_PUBLIC_API RealDelegate:public QStyledItemDelegate {
    Q_OBJECT
    ...
    public:
         ...
         */
        RealDelegate(QObject* parent = Q_NULLPTR);
