...
* \file
*
* This header defines the \ref MatrixRealDataTypePresentationGenerator class.
*********************************************************f**************************************************************/

/* .. sphinx-project ineapp */

#ifndef MATRIX_REAL_DATA_TYPE_PRESENTATION_GENERATOR_H
#define MATRIX_REAL_DATA_TYPE_PRESENTATION_GENERATOR_H
...
/**
 * Presentation generator that renders real matrices.
 */
class APP_PUBLIC_API MatrixRealDataTypePresentationGenerator:public virtual MatrixDataTypePresentationGeneratorBase,
                                                                public virtual Ld::MatrixRealDataTypeDecoder {
    public:
        /**
         * Contexts used to render real matricies.
         */
        class APP_PUBLIC_API Context:public virtual MatrixDataTypePresentationGeneratorBase::Context,
            ...
            public:
                 ...
                 */
                Context(const Model::MatrixReal& matrix, Ld::FormatPointer format, float relativeScale);
         ...
         */
        static const MatrixRealDataTypePresentationGenerator instance;

        MatrixRealDataTypePresentationGenerator();

        ~MatrixRealDataTypePresentationGenerator() override;
