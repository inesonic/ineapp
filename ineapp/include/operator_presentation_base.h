...
* \file
*
* This header defines the \ref OperatorPresentationBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef OPERATOR_PRESENTATION_BASE_H
#define OPERATOR_PRESENTATION_BASE_H
...
/**
 * You can use this class as a base class for operator presentations with a fixed number of elements.
 */
class APP_PUBLIC_API OperatorPresentationBase:public PresentationWithFixedChildren {
    Q_OBJECT
    ...
    public:
         ...
         */
        typedef Ld::Element::ParenthesisStyle ParenthesisStyle;

        OperatorPresentationBase();

        ~OperatorPresentationBase() override;
    ...
    protected slots:
         ...
         */
        void tiedToElement(Ld::ElementPointer element) override;
         ...
         *
         *     * Ld::ElementWithFixedChildren::removeChild(Element*)
         *     * Ld::ElementWithFixedChildren::removeChild(unsigned long)
         *
    ...
    protected:
        /**
         * Method you can overload to provide a font for the operator.  This method will take into account the
         * application font scale factor as well as a supplied relative scale.
         *
         * \param[in] operatorFormat The format instance tied to this operator.
         *
         * \param[in] relativeScale  The relative scale factor to apply to the font.
         *
         * The default implementation obtains the font from the current format.
         *
         * \return Returns the operator font.
         */
        virtual QFont operatorFont(Ld::FormatPointer operatorFormat, float relativeScale) const;

        /**
         * Method you can overload to obtain the color to apply to the operator and parenthesis.
         *
         * The default implementation obtains the color from the current format.
         *
         * \param[in] operatorFormat The format instance tied to this operator.
         *
         * \return Returns the operator color.  An invalid color indicates the default/black color.
         */
        virtual QColor operatorColor(Ld::FormatPointer operatorFormat) const;

        /**
         * Method you can use to obtain the background color.
         *
         * The default implementation obtains the color from the current format.
         *
         * \param[in] operatorFormat The format instance tied to this operator.
         *
         * \return Returns the background color to apply.  An invalid color indicates the default/white color.
         */
        virtual QColor backgroundColor(Ld::FormatPointer operatorFormat) const;

        /**
         * Method that is called to determine the desired parenthesis style.  The default implementation will simply
         * query the element for the parenthesis style.
         *
         * \param[in] element Pointer to element we are rendering.
         *
         * \return Returns the desired parenthesis style.  A value of type
         *         OperatorPresentationBase::ParenthesisStyle::INVALID_OR_NONE is returned if parenthesis are not
         *         required.
         */
        virtual ParenthesisStyle parenthesisStyle(Ld::ElementPointer element) const;
         ...
         */
        virtual float childRelativeScale(float parentRelativeScale, unsigned long childIndex) const;

        /**
         * Method that sets the text and background colors.  The default implementation fetches color information from
         * the \ref OperatorPresentationBase::operatorColor and \ref OperatorPresentationBase::backgroundColor virtual
         * methods.
         *
         * \param[in] format       Pointer to the format instance tied to the element.
         *
         * \param[in] graphicsItem The graphics item to be updated.
         */
        void setColors(EQt::GraphicsMathGroup* graphicsItem, Ld::FormatPointer format);
         ...
         */
        virtual EQt::GraphicsMathGroup* buildGraphicsItem(
         ...
         */
        virtual EQt::GraphicsMathGroup* updateGraphicsItem(
            Ld::FormatPointer                     format,
        ...
        /**
         * Convenience method that adds presentation areas horizontally across a EQt::GraphicsItemGroup.
         *
         * \param[in] presentationAreas The presentation area data instance to use to populate the graphics item group.
         *
         * \param[in] graphicsItemGroup The EQt::GraphicsItemGroup to be populated.
         *
         * \param[in] topLeftCorner     The top-left most edge of the region to be populated.
         *
         * \param[in] maximumAscent     The maximum ascent of any item.  The Y offset is calculated by subtracting the
         *                              ascent of each item from this value.
         *
         * \return Returns the final, right-most X position of any object.
         */
        static float addPresentationAreas(
        ...
        /**
         * Method that populates our child presentation area trackers.  This method simply calls
         * \ref Presentation::recalculatePlacement on each child presentation.
         *
         ...
         *
         * \param[in] relativeScale    The relative scale to impose on our children.
         */
        void populateTrackers(PlacementTracker* placementTracker, float relativeScale);

        /**
         * Method that adjusts the number of trackers to match the number of children.
         */
        void reallocateTrackers();
    ...
    private:
         ...
         */
        QList<PresentationAreaTracker> currentChildPresentationAreas;
