...
* \file
*
* This header defines the \ref ComplexDataTypePresentationGenerator class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef COMPLEX_DATA_TYPE_PRESENTATION_GENERATOR_H
#define COMPLEX_DATA_TYPE_PRESENTATION_GENERATOR_H
...
/**
 * Presentation generator used to render complex values.
 */
class APP_PUBLIC_API ComplexDataTypePresentationGenerator:public virtual Ld::ComplexDataTypeDecoder,
                                                          public virtual RealDataTypePresentationGeneratorBase {
    Q_DECLARE_TR_FUNCTIONS(ComplexDataTypePresentationGenerator)

    public:
        /**
         * Static instance you can use for the application configuration.
         */
        static const ComplexDataTypePresentationGenerator instance;

        ComplexDataTypePresentationGenerator();

        ~ComplexDataTypePresentationGenerator() override;
