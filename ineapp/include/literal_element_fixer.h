...
* \file
*
* This header defines the \ref LiteralElementFixer class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef LITERAL_ELEMENT_FIXER_H
#define LITERAL_ELEMENT_FIXER_H
...
/**
 * Class that fixes-up literal elements after specific operations.
 *
 * Note that fixer instances are expected to be created as static const instances.
 */
class APP_PUBLIC_API LiteralElementFixer:public Fixer {
    public:
        /**
         * Static instance of this fixer to be used by the application.
         */
        static const LiteralElementFixer instance;

        LiteralElementFixer();

        ~LiteralElementFixer() override;
