...
* \file
*
* This header defines the \ref IfOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef IF_OPERATOR_PRESENTATION_H
#define IF_OPERATOR_PRESENTATION_H
...
/**
 * This class provides a presentation for the Ld::IfOperatorElement class.
 */
class APP_PUBLIC_API IfOperatorPresentation:public         ControlFlowOperatorPresentationBase,
                                            public virtual Ld::IfOperatorVisual {
    Q_OBJECT

    public:
        IfOperatorPresentation();

        ~IfOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref IfOperatorPresentation class.
         *
