...
* \file
*
* This header defines the \ref UnarySuperscriptOperatorPresentationBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef UNARY_SUPERSCRIPT_OPERATOR_PRESENTATION_BASE_H
#define UNARY_SUPERSCRIPT_OPERATOR_PRESENTATION_BASE_H
...
/**
 * You can use this class as a base class for unary superscripting operator presentations.
 */
class APP_PUBLIC_API UnarySuperscriptOperatorPresentationBase:public OperatorPresentationBase {
    Q_OBJECT

    public:
        UnarySuperscriptOperatorPresentationBase();

        ~UnarySuperscriptOperatorPresentationBase() override;
