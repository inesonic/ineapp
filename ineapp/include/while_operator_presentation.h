...
* \file
*
* This header defines the \ref WhileOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef WHILE_OPERATOR_PRESENTATION_H
#define WHILE_OPERATOR_PRESENTATION_H
...
/**
 * This class provides a presentation for the Ld::WhileOperatorElement class.
 */
class APP_PUBLIC_API WhileOperatorPresentation:public         ControlFlowOperatorPresentationBase,
                                               public virtual Ld::WhileOperatorVisual {
    Q_OBJECT

    public:
        WhileOperatorPresentation();

        ~WhileOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref WhileOperatorPresentation class.
         *
