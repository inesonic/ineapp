...
* \file
*
* This header defines the \ref BraceConditionalOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef BRACE_CONDITIONAL_OPERATOR_PRESENTATION_H
#define BRACE_CONDITIONAL_OPERATOR_PRESENTATION_H
...
/**
 * This class provides a presentation for the Ld::BraceConditionalOperatorElement class.
 */
class APP_PUBLIC_API BraceConditionalOperatorPresentation:public         OperatorPresentationBase,
                                                          public virtual Ld::BraceConditionalOperatorVisual {
    Q_OBJECT

    public:
        BraceConditionalOperatorPresentation();

        ~BraceConditionalOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref BraceConditionalOperatorPresentation class.
         *
