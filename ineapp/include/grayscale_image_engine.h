...
* \file
*
* This header defines the \ref GrayscaleImageEngine class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef GRAYSCALE_IMAGE_ENGINE_H
#define GRAYSCALE_IMAGE_ENGINE_H
...
/**
 * Class that implements a plot-like renderer for grayscale images.
 */
class APP_PUBLIC_API GrayscaleImageEngine:public ImageRenderEngine {
    Q_DECLARE_TR_FUNCTIONS(GrayscaleImageEngine)

    public:
        /**
         * Global instance.
         */
        static const GrayscaleImageEngine instance;

        GrayscaleImageEngine();

        ~GrayscaleImageEngine() override;
