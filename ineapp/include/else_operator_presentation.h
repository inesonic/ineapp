...
* \file
*
* This header defines the \ref ElseOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef ELSE_OPERATOR_PRESENTATION_H
#define ELSE_OPERATOR_PRESENTATION_H
...
/**
 * This class provides a presentation for the Ld::ElseOperatorElement class.
 */
class APP_PUBLIC_API ElseOperatorPresentation:public         OperatorPresentationBase,
                                            public virtual Ld::ElseOperatorVisual {
    Q_OBJECT

    public:
        ElseOperatorPresentation();

        ~ElseOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref ElseOperatorPresentation class.
         *
