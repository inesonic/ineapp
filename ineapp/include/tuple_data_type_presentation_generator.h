...
* \file
*
* This header defines the \ref TupleDataTypePresentationGenerator class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef TUPLE_DATA_TYPE_PRESENTATION_GENERATOR_H
#define TUPLE_DATA_TYPE_PRESENTATION_GENERATOR_H
...
/**
 * Presentation generator used to render tuple values.
 */
class APP_PUBLIC_API TupleDataTypePresentationGenerator:public virtual Ld::TupleDataTypeDecoder,
                                                        public virtual DataTypePresentationGenerator,
                                                        private        TextPresentationHelper {
    Q_DECLARE_TR_FUNCTIONS(TupleDataTypePresentationGenerator)

    public:
        /**
         * Static instance you can use for the application configuration.
         */
        static const TupleDataTypePresentationGenerator instance;

        TupleDataTypePresentationGenerator();

        ~TupleDataTypePresentationGenerator() override;
    ...
    private:
        /**
         * Method that is called to render a tuple using the wrapped format.
         *
         * \param[in]     placementTracker         A pointer to the placement tracker that can be used to track and
         *                                         update status during a time-consuming placement operation.
         *
         ...
         * \param[in]     presenter                Pointer to the presenter requesting the rendering operation.
         *
         * \param[in]     tuple                    The tuple to be rendered.
         *
         ...
         *
         * \param[in]     leadingMemberCount       The number of children at the front of the tuple to be rendered.
         *
         * \param[in]     trailingMemberCount      The number of children at the end of the tuple to be rendered.
         *
         * \param[in]     hiddenMemberCount        The number of unrendered children.
         *
         * \param[in]     showHiddenMemberCount    If true, the rendered tuple should show the number of children that
         *                                         were not rendered.
         *
         * \param[in]     lineSpacing              Additional line spacing that should be optionally included by this
         *                                         child.  Children can adjust the height they report for their
        ...
        /**
         * Method that is called to calculate the maximum ascent and descent across a range of tuple entries.
         *
         * \param[in]     placementTracker A pointer to the placement tracker that can be used to track and update
         *                                 status during a time-consuming placement operation.
         *
         * \param[in,out] tupleIterator    Iterator to the first member of the tuple to be rendered.
         *
         * \param[in]     memberCount      The number of tuple members to be rendered.
         *
         * \param[in]     format           The format to use for the child elements.
         *
        ...
        /**
         * Method that is called to render a range of values in a tuple.
         *
         * \param[in]     placementTracker         A pointer to the placement tracker that can be used to track and
         *                                         update status during a time-consuming placement operation.
         *
         * \param[in,out] tupleIterator            Iterator to the first member of the tuple tobe rendered.
         *
         * \param[in]     memberCount              The number of tuple members to be rendered.
         *
         * \param[in,out] isFirstEntry             Flag that is used to identify if a comma is needed before the
         *                                         first entry.  The value will be tuple to false after an entry is
         *                                         rendered.
         *
         * \param[in,out] currentPresentationAreas The current list of presentation areas.
         *
         ...
         *                                         parameter.
         */
        static void renderTupleMembers(
            PlacementTracker*                     placementTracker,
            Model::Tuple::ConstIterator&          tupleIterator,
            unsigned long                         memberCount,
            bool&                                 isFirstEntry,
