...
* \file
*
* This header defines the \ref RootOperatorPresentation class.
***********************************************************************************************************************/

/* .. sphinx-project ineapp */

#ifndef ROOT_OPERATOR_PRESENTATION_H
#define ROOT_OPERATOR_PRESENTATION_H
...
/**
 * This class provides a presentation for the Ld::RootOperatorElement class.
 */
class APP_PUBLIC_API RootOperatorPresentation:public         RootOperatorPresentationBase,
                                              public virtual Ld::RootOperatorVisual {
    Q_OBJECT

    public:
        RootOperatorPresentation();

        ~RootOperatorPresentation() override;

        /**
         * Static method that creates an instance of a \ref RootOperatorPresentation class.
         *
